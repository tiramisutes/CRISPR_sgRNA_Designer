...
mkdir("$dir/sgRNAcas9.report_$truncat.$Option.$faname",0755)||die "Can't create directory: Directory exists at $dir. Please delete, move or rename the exist directory before you run this program.$!" ;

open  (LOG, ">>$dir/sgRNAcas9.report_$truncat.$Option.$faname/sgRNAcas9.Log.txt") || die "Can't open sgRNAcas9.Log.txt for writing!" ."\n";
print  LOG "################################# Log ###########################################".        "\n\n";
...
#mkdir("$dir/sgRNAcas9.report_$truncat.$Option.$faname/A.Final_report",0755)||die "can't create directory: $!" ;
...
open (FASTA, ">$dir/sgRNAcas9.report_$truncat.$Option.$faname/TargetSeq.fa") || die "Can't open TargetSeq.fa for writing!\n";
...
open(IntPut, "$dir/sgRNAcas9.report_$truncat.$Option.$faname/TargetSeq.fa") || die "Can't open TargetSeq.fa for reading!\n";

open(OutPut, ">$dir/sgRNAcas9.report_$truncat.$Option.$faname/report_protospacer_single.txt") || die "Can't open report_protospacer_single.txt for writing!\n";
open(OutPut1, ">$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_single.fa") || die "Can't open CRISPR.targets_single.fa for writing!\n";
#open(OutPut2, ">$dir/sgRNAcas9.report_$truncat.$Option.$faname/full_length_sgRNA.txt") || die "Can't open full_length_sgRNA.txt for writing!\n";
open(OutPut3, ">$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_S.txt") || die "Can't open CRISPR.targets_single.fa for writing!\n";
open(OutPut4, ">$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_A.txt") || die "Can't open CRISPR.targets_single.fa for writing!\n";
...
open( PA, "<$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_A.txt" ) || die "can't open CRISPR.targets_A.txt!";
open( PS, "<$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_S.txt" ) || die "can't open CRISPR.targets_S.txt!";
open( PAIRS1, ">>$dir/sgRNAcas9.report_$truncat.$Option.$faname/report_protospacer_pairs.xls" ) || die "can't open report_protospacer_pairs.xls!";
open( PAIRS2, ">>$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_pairs.fa" ) || die "can't open CRISPR.targets_pairs.fa!";
...
my %seq;
my $title;
my $infile="$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_pairs.fa";
...
open (OUT,">$dir/sgRNAcas9.report_$truncat.$Option.$faname/unique_pairs.fa");
foreach (@uniqueseq){
	print OUT ">$seq{$_}\n$_\n";
}
close OUT;
...
if ($Seqmap_vesion eq "l" and $Type eq "s") {       #Linux-64
	...
	my @args = ("./Seqmap/seqmap-1.0.12-linux-64","$Num_mismatch", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_single.fa", "$Genome", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/seqmap_output.txt", "/output_all_matches");
	system(@args);
	...
	my @args = ("./Seqmap/seqmap-1.0.12-linux-64","$Num_mismatch", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/unique_pairs.fa", "$Genome", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/seqmap_output.txt", "/output_all_matches");
	system(@args);
	...
	my @args = ("./Seqmap/seqmap-1.0.12-windows.exe","$Num_mismatch", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_single.fa", "$Genome", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/seqmap_output.txt", "/output_all_matches");
	system(@args);
	...
	my @args = ("./Seqmap/seqmap-1.0.12-windows.exe","$Num_mismatch", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/unique_pairs.fa", "$Genome", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/seqmap_output.txt", "/output_all_matches");
	system(@args);
	...
	my @args = ("./Seqmap/seqmap-1.0.12-mac-64","$Num_mismatch", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_single.fa", "$Genome", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/seqmap_output.txt", "/output_all_matches");
	system(@args);
	...
	my @args = ("./Seqmap/seqmap-1.0.12-mac-64","$Num_mismatch", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/unique_pairs.fa", "$Genome", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/seqmap_output.txt", "/output_all_matches");
	system(@args);
	...
	my @args = ("./Seqmap/seqmap-1.0.12-mac","$Num_mismatch", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_single.fa", "$Genome", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/seqmap_output.txt", "/output_all_matches");
	system(@args);
	...
	my @args = ("./Seqmap/seqmap-1.0.12-mac","$Num_mismatch", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/unique_pairs.fa", "$Genome", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/seqmap_output.txt", "/output_all_matches");
	system(@args);
	...
	my @args = ("./Seqmap/seqmap-1.0.12-linux","$Num_mismatch", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_single.fa", "$Genome", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/seqmap_output.txt", "/output_all_matches");
	system(@args);
	...
	my @args = ("./Seqmap/seqmap-1.0.12-linux","$Num_mismatch", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/unique_pairs.fa", "$Genome", "$dir/sgRNAcas9.report_$truncat.$Option.$faname/seqmap_output.txt", "/output_all_matches");
	system(@args);
...
open(Input, "$dir/sgRNAcas9.report_$truncat.$Option.$faname/seqmap_output.txt") || die "Can't open seqmap_output.txt for reading!\n";
open(Out, ">$dir/sgRNAcas9.report_$truncat.$Option.$faname/report_sgRid.txt") || die "Can't open report_sgRid.txt for writing!\n";
...
mkdir("$dir/sgRNAcas9.report_$truncat.$Option.$faname/A.Sort_OT_byID",0755)||die "can't create directory: $!" ;
#mkdir("$dir/sgRNAcas9.report_$truncat.$Option.$faname/D.Type_II_POT",0755)||die "can't create directory: $!" ;
mkdir("$dir/sgRNAcas9.report_$truncat.$Option.$faname/POT_seed.identity",0755)||die "can't create directory: $!" ;
...
open(Seq, "<$dir/sgRNAcas9.report_$truncat.$Option.$faname/seqmap_output.txt" ) || die "can't open seqmap_output.txt!";
open(sgR, "<$dir/sgRNAcas9.report_$truncat.$Option.$faname/report_sgRid.txt" ) || die "can't open report_sgRid.txt!";

open(Out3, ">$dir/sgRNAcas9.report_$truncat.$Option.$faname/search_OT.txt") || die "Can't open search_OT.txt for writing!\n";
...
while (<Seq>) {
	...
	while (<sgR>) {
	    ...
	    next if ($trans_id eq "trans_id" or (substr($target_seq,$len3,1) ne "G") or (substr($target_seq,$len4,1) eq "T") or (substr($target_seq,$len4,1) eq "C") ) ;
			...
			open (Out2,">>$dir/sgRNAcas9.report_$truncat.$Option.$faname/A.Sort_OT_byID/$sgR_ID.txt");
	   ...
	   #                                                     NAG                      [N]-GG                                        
	    if($num_mismatch > 0 and (substr($target_seq,$len4,1) eq "A" or (substr($target_seq,$truncat,1) ne substr($probe_seq,$truncat,1)))){
			...
			open (Out5,">>$dir/sgRNAcas9.report_$truncat.$Option.$faname/POT_seed.identity/$sgR_ID.seed.identity.txt");
...
mkdir("$dir/sgRNAcas9.report_$truncat.$Option.$faname/B.Sort_POT_byID",0755)||die "can't create directory: $!" ;

my $Dir = "$dir/sgRNAcas9.report_$truncat.$Option.$faname/A.Sort_OT_byID" ;
...
foreach my $file (@list){
	...
	open(OUTi,">>$dir/sgRNAcas9.report_$truncat.$Option.$faname/B.Sort_POT_byID/$file.POT.txt") || die "Can't open $file.POT.txt for writing!\n";
...
########count_ot#########
my $Dir3_ot = "$dir/sgRNAcas9.report_$truncat.$Option.$faname/A.Sort_OT_byID" ;
...
open(OutPut, ">$dir/sgRNAcas9.report_$truncat.$Option.$faname/report_count_total_ot.txt") || die "Can't open report_count_total_ot.txt for writing!\n";
...
########count_pot#########
my $Dir3 = "$dir/sgRNAcas9.report_$truncat.$Option.$faname/POT_seed.identity" ;
...
my $file_pot;
open(OutPut, ">$dir/sgRNAcas9.report_$truncat.$Option.$faname/report_count_total_pot.txt") || die "Can't open report_count_total_pot.txt for writing!\n";
...
#########
#########
my $File1_ot = "$dir/sgRNAcas9.report_$truncat.$Option.$faname/report_protospacer_single.txt";
my $File2_ot = "$dir/sgRNAcas9.report_$truncat.$Option.$faname/report_count_total_ot.txt";
...
open( PAIRS1, ">$dir/sgRNAcas9.report_$truncat.$Option.$faname/single_and_ot.txt" ) || die "can't open single_and_ot.txt!";
...
#########
my $File1 = "$dir/sgRNAcas9.report_$truncat.$Option.$faname/single_and_ot.txt";
my $File2 = "$dir/sgRNAcas9.report_$truncat.$Option.$faname/report_count_total_pot.txt";
...
#unlink ("$dir/sgRNAcas9.report_$truncat.$Option.$faname/seqmap_output.txt")||die "Can't delete seqmap_output.txt file";
#unlink ("$dir/sgRNAcas9.report_$truncat.$Option.$faname/search_OT.txt")||die "Can't delete search_OT.txt file";
#unlink ("$dir/sgRNAcas9.report_$truncat.$Option.$faname/unique_pairs.fa")||die "Can't delete unique_pairs.fa file";
#unlink ("$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_A.txt")||die "Can't delete CRISPR.targets_A.txt file";
#unlink ("$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_S.txt")||die "Can't delete CRISPR.targets_S.txt file";
#unlink ("$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_pairs.fa")||die "Can't delete CRISPR.targets_pairs.fa file";
#unlink ("$dir/sgRNAcas9.report_$truncat.$Option.$faname/CRISPR.targets_single.fa")||die "Can't delete CRISPR.targets_single.fa file";
#unlink ("$dir/sgRNAcas9.report_$truncat.$Option.$faname/report_sgRid.txt")||die "Can't delete report_sgRid.txt file";
#unlink ("$dir/sgRNAcas9.report_$truncat.$Option.$faname/report_protospacer_single.txt")||die "Can't delete report_protospacer_single.txt";
#unlink ("$dir/sgRNAcas9.report_$truncat.$Option.$faname/report_count_total_ot.txt")||die "Can't delete report_count_total_ot.txt";
#unlink ("$dir/sgRNAcas9.report_$truncat.$Option.$faname/report_count_total_pot.txt")||die "Can't delete report_count_total_pot.txt";
#unlink ("$dir/sgRNAcas9.report_$truncat.$Option.$faname/single_and_ot.txt")||die "Can't delete single_and_ot.txt";
